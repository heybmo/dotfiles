...
wk.add({
	...
	-- NOTE:
	-- MOST OF THESE KEYMAPS ARE NOW IN SNACKS.NVIM
	-- Goto/Git
	-- {
	-- 	"<leader>gB",
	-- 	function()
	...
	-- 	"<leader>gta",
	-- 	function()
	-- 		local enabled = require("blink.cmp.config").completion.menu.enabled
	-- 		local flipped = not enabled
	-- 		require("blink.cmp.config").completion.menu.enabled = flipped
	-- 		Snacks.notifier.notify("Completion turned " .. tostring(flipped), "info")
	-- 	end,
	...
	-- 	"<leader>pf",
	-- 	function()
	-- 		-- Live grep from git root with search from root fallback
